...
def update_collection_user_agent(
    collection_path: PosixPath, var_name: str, galaxy_version: str
) -> bool:
    ...
    return any(
        ...
        for src in _get_files_from_directory(PosixPath(collection_path / "plugins"))
...
def main() -> None:
    ...
    collection_info = {}
    with PosixPath(args.path / "galaxy.yml").open(encoding="utf-8") as file_desc:
    ...
    update_collection_user_agent(args.path, variable_name, galaxy_version)
